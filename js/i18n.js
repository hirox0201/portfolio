...
const UI_I18N = {
  ...
  about_bio_html:      { zh:"<p>楊 殿宏（TIM YANG），1982年生，SOLOキャンプ40代おじさん。I人無誤、大叔級資深肥宅王者，日本旅遊超過四十趟，旅居醉酒有達2個月，主要出沒在東京和關東地區，熱愛露營、金屬類音樂，遊戲資歷從任天堂紅白機發售到現在PS5，有資訊前端工程背景、 SCA 烘豆師資格的 OUTDOOR LIFE 視覺專案管理師。</p>",
                          en:"<p>Hi there! I'm Tim Yang (born in 1982)—a 40-something solo camping enthusiast, a proud introvert (100% I-person!), and a self-proclaimed high-level seasoned otaku大叔.</p><p>Japan is practically my second home: I've visited over 40 times and even lived there for up to 2 months at a time, mostly hanging out around Tokyo and the Kanto region.</p><p>A few things that fuel my soul:</p><ul><li>🏕️ Outdoor Living &amp; Solo Camping</li><li>🎸 Heavy Metal Music</li><li>🎮 Gaming (a lifelong gamer who started with the original Nintendo NES all the way to the PS5!)</li></ul><p>Professionally, I'm an Outdoor Life Visual Project Manager with a background in front-end web development and a certified SCA Coffee Roaster.</p>" },
